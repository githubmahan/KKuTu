...
exports.MAIN_PORTS = GLOBAL.SERVER_OPTIONS.MAIN_PORTS;
exports.CUSTOM_OG = GLOBAL.CUSTOM_OG
exports.OG_URL = GLOBAL.OG_URL
exports.OG_TITLE = GLOBAL.OG_TITLE
exports.OG_DESC = GLOBAL.OG_DESC
...
exports.TESTER = GLOBAL.TESTER
exports.IS_SECURED = GLOBAL.SSL_OPTIONS.IS_SECURED;
exports.SSL_OPTIONS = GLOBAL.SSL_OPTIONS;
exports.WAF = GLOBAL.SSL_OPTIONS.WAF;
exports.ROOM_PORTS = GLOBAL.SERVER_OPTIONS.ROOM_PORTS;
exports.OPTIONS = {
	'man': { name: "Manner" },
	'ext': { name: "Injeong" },
	'mis': { name: "Mission" },
...
exports.MOREMI_PART = [ 'back', 'skin', 'eye', 'mouth', 'shoes', 'clothes', 'badge', 'head', 'lhand', 'rhand', "front" ];
exports.CATEGORIES = [ "all", "spec", "skin", "insignia", "badge", "head", "eye", "mouth", "clothes", "hs", "back" ];
exports.AVAIL_EQUIP = [
	"NIK", "BDG1", "BDG2", "BDG3", "BDG4",
	"Mhead", "Meye", "Mmouth", "Mhand", "Mclothes", "Mshoes", "Mback", "Mskin", "Mbadge"
];
exports.GROUPS = {
	'spec': [ "PIX", "PIY", "PIZ", "CNS" ],
	'skin': [ "NIK", "Mskin" ],
	'insignia': [ "BDG1", "BDG2", "BDG3", "BDG4" ],
	'badge': [ "Mbadge" ],
	'head': [ "Mhead" ],
	'eye': [ "Meye" ],
	'mouth': [ "Mmouth" ],
...
*/
	...
	'KKT': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "k32", "rtn", "rtu", "ukn" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KSH': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "rtn", "rtu", "ukn" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
...
exports.INIT_CONSONANTS = [ "ㄱ", "ㄲ", "ㄴ", "ㄷ", "ㄸ", "ㄹ", "ㅁ", "ㅂ", "ㅃ", "ㅅ", "ㅆ", "ㅇ", "ㅈ", "ㅉ", "ㅊ", "ㅋ", "ㅌ", "ㅍ", "ㅎ" ];
