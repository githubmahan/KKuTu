...
$audiosets = {
	"0": [
		...
		{
			key: "lobby1",
			value: "/media/LobbyOST1.mp3"
		},
		{
			key: "lobby2",
			value: "/media/LobbyOST2.mp3"
		},
		{
			key: "jaqwi",
...
// 메뉴 버튼
	...
	// 	var id = $data.users[$data._profiled];
...
function addonNickname($R, o){
	...
	if(o.equip['Mback'] == "gm_gm") $R.addClass("x-gm");
	if(o.equip['Mback'] == "gm_sgm") $R.addClass("x-sgm");
	if(o.equip['Mback'] == "gm_dgm") $R.addClass("x-dgm");
	if(o.equip['Mback'] == "gm_magm") $R.addClass("x-magm");
	if(o.equip['Mback'] == "gm_wgm") $R.addClass("x-wgm");
	if(o.equip['Mback'] == "gm_pgm") $R.addClass("x-pgm");
	if(o.equip['Mback'] == "gm_mgm") $R.addClass("x-mgm");
	if(o.equip['Mback'] == "gm_mkgm") $R.addClass("x-mkgm");
}
...
function playSound(key, loop){
	...
	$_sound[key] = src;
	src.key = key === "lobby" || key === "lobby4fool" || key === "lobby1" || key === "lobby2" ? "lobby" : key;
	src.start();
