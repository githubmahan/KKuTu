...
Server.get("/", function(req, res){
	...
	function onFinish($doc){
		...
		page(req, res, Const.MAIN_PORTS[server] ? "kkutu" : "service_stop", {
			'_page': "kkutu",
			'_id': id,
			...
			'ogImage': GLOBAL.OG_OPTIONS.CUSTOM_OG ?
				GLOBAL.OG_OPTIONS.OG_IMAGE : "http://kkutu.kr/img/kkutu/logo.png",
			'ogURL': GLOBAL.OG_OPTIONS.CUSTOM_OG ?
				GLOBAL.OG_OPTIONS.OG_URL : "http://kkutu.kr/",
			'ogTitle': GLOBAL.OG_OPTIONS.CUSTOM_OG ?
				GLOBAL.OG_OPTIONS.OG_TITLE : "글자로 놀자! 끄투 온라인",
			'ogDescription': GLOBAL.OG_OPTIONS.CUSTOM_OG ?
				GLOBAL.OG_OPTIONS.OG_DESC : "끝말잇기가 이렇게 박진감 넘치는 게임이었다니!",
			'MAX_USERS': 400
		});
	}
});
