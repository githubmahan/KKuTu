...
module.exports.config = {
    strategy: require('passport-roblox').Strategy,
    color: '#00A2FF',
    fontColor: '#FFFFFF',
    vendor: 'roblox',
    displayName: 'withRoblox'
}

module.exports.strategyConfig = {
    clientID: config.roblox.clientID, // 보안을 위해서입니다.
    clientSecret: config.roblox.clientSecret, // 이 방법을 사용하는 것을
    callbackURL: config.roblox.callbackURL, // 적극 권장합니다.
    state: true,
    scope: 'openid',
    pkce: true,
